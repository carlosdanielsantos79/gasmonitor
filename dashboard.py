...
st.markdown('<span style="font-size: 11px;">Data source: Weekly Oil Bulletin Price Developments (https://energy.ec.europa.eu/data-and-analysis/weekly-oil-bulletin_en).</span>', unsafe_allow_html=True)
